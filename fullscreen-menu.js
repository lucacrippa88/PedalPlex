...
<div class="fullscreen-menu" id="fullscreenMenu"><br>
  ...
  <div class="fullscreen-nav">
    ...
    <button id="profileBtn" class="bx--btn bx--btn--secondary" type="button" aria-label="Your profile" style="display: flex; align-items: center; gap: 0.5rem;">
    ...
    <button id="settingsBtn" class="bx--btn bx--btn--secondary" type="button" aria-label="Settings" style="display: flex; align-items: center; gap: 0.5rem;">
      <svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="16" height="16" viewBox="0 0 32 32" aria-hidden="true" class="bx--btn__icon">
  ...
  <div class='menu-footer' style="margin-top:4rem; text-align:center; padding:1rem; font-size:0.875rem; color:#aaa;">
    ...
    <a href="terms">Terms</a> · <a href="privacy">Privacy</a> · <a href="mailto:support@pedalplex.com">Support</a> · Developed in Italy <span style="display: inline-block; width: 20px; height: 4px; background: linear-gradient(to right, #008C45 33.33%, #F4F5F0 33.33% 66.66%, #CD212A 66.66%); vertical-align: middle"></span>
  </div>
</div>
`;
...
function updateFullscreenMenu() {
  if (!window.currentUser || window.currentUser.role === "guest") {
    ...
    $("#profileBtn, #settingsBtn, #logoutBtn").hide();
  } else {
    $("#loginFullscreenBtn, #guestLoginMessage").hide();
    $("#profileBtn, #settingsBtn, #logoutBtn").show();
  }
}
