    ...
    html: `
        ...
        <div id="shareLinkContainer" style="margin-top:1rem; display:none;">
            ...
            <button id="copyLinkBtn" class="bx--btn bx--btn--secondary bx--btn--icon-only">
                <svg focusable='false' preserveAspectRatio='xMidYMid meet' xmlns='http://www.w3.org/2000/svg' fill='currentColor' width='16' height='16' viewBox='0 0 32 32' aria-hidden='true' class='bx--btn__icon'><path d='M6 18H20V20H6z'></path><path d='M6 12H26V14H6z'></path></svg>
            </button>
            </div>
            <br>
        </div>
