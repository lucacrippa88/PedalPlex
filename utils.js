  ...
  $(document).on("click", ".edit-btn", function () {
    ...
    if (!pedal.controls || pedal.controls.length === 0) {
      ...
      .then(fullPedalRes => {
        ...
        // ✅ Continua l’esecuzione originale aprendo il modal
        openPedalModal();
      })
    ...
    // --- Se ci sono già i controlli, apriamo direttamente il modal ---
    openPedalModal();

    // --- Funzione interna per aprire il modal mantenendo la stessa struttura ---
    function openPedalModal() {
          ...
          Swal.fire({
            ...
            if (deleteConfirm.isConfirmed) {
              ...
              .then(text => {
                ...
                Swal.hideLoading();
                if (data.success) {
                  Swal.fire({ title: 'Deleted!', text: 'The gear has been removed.', icon: 'success', confirmButtonText: 'OK', customClass: { confirmButton: 'bx--btn bx--btn--primary' } }).then(() => {
