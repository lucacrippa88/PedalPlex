...
function createNewPedal() {
  ...
  Swal.fire({
    ...
    preConfirm: (jsonText) => { if (!jsonText) { Swal.showValidationMessage('JSON is required'); return false; } try { const parsed = JSON.parse(jsonText); // Check for "position: relative" in logo 
      console.log(parsed) 
