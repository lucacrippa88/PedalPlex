...
const pedalCategoryMap = {
  ...
  dibox: ["dibox", "di box", "direct box"],
  distortion: ["distortion", "dist", "distort", "metal", "heavy", "dark", "feedbacker", "feedback"],
  eq: ["equal", "equalizer", "equaliser"],
  ...
  vibrato: ["rotary", "rotovibe", "roto-vibe", "vibrato", "vibe", "vib"],
  sustainer: ["sustainer", "sustain"],
  switcher: ["switcher", "switch", "sw", "footswitch", "loop switcher", "ab switcher", "drop", "aby"],
  synth: ["spectrum", "enhancer", "spec", "sampler", "sample", "samp", "filter", "filt", "formant", "lfo", "synth", "synthesizer", "synthesiser", "slicer", "processor", "organ", "bitcrusher", "bit crusher", "crusher", "lofi", "lo-fi"],
  tremolo: ["tremolo", "trem"],
  tuner: ["tuner", "tunr", "tnr"],
  vocoder: ["vocoder", "voco", "vokoder", "talk box"],
  wah: ["wah", "wah-wah"]
